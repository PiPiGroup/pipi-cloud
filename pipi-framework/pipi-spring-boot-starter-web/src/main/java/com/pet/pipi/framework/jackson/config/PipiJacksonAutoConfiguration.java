package com.pet.pipi.framework.jackson.config;

import com.pet.pipi.framework.common.util.json.JsonUtils;
import com.pet.pipi.framework.common.util.json.databind.NumberSerializer;
import com.pet.pipi.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.pet.pipi.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class PipiJacksonAutoConfiguration {
