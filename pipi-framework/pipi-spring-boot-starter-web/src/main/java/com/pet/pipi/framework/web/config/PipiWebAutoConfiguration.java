package com.pet.pipi.framework.web.config;
...
import com.pet.pipi.framework.web.core.filter.CacheRequestBodyFilter;
import com.pet.pipi.framework.web.core.filter.DemoFilter;
import com.pet.pipi.framework.web.core.handler.GlobalExceptionHandler;
import com.pet.pipi.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class PipiWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "pipi.demo", havingValue = "true")
