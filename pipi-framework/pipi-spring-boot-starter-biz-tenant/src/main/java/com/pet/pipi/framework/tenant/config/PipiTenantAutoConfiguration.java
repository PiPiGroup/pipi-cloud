...
import com.pet.pipi.framework.redis.config.PipiCacheProperties;
import com.pet.pipi.framework.security.core.service.SecurityFrameworkService;
import com.pet.pipi.framework.tenant.core.aop.TenantIgnore;
import com.pet.pipi.framework.tenant.core.aop.TenantIgnoreAspect;
import com.pet.pipi.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.pet.pipi.framework.tenant.core.job.TenantJobAspect;
import com.pet.pipi.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.pet.pipi.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.pet.pipi.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.pet.pipi.framework.tenant.core.redis.TenantRedisCacheManager;
import com.pet.pipi.framework.tenant.core.security.TenantSecurityWebFilter;
import com.pet.pipi.framework.tenant.core.service.TenantFrameworkService;
import com.pet.pipi.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.pet.pipi.framework.tenant.core.web.TenantContextWebFilter;
import com.pet.pipi.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class PipiTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/pipi-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "com.pet.pipi.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     PipiCacheProperties pipiCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(pipiCacheProperties.getRedisScanBatchSize()));
