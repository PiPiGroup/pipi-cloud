package com.pet.pipi.framework.tracer.config;

import com.pet.pipi.framework.common.enums.WebFilterOrderEnum;
import com.pet.pipi.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "pipi.tracer", value = "enable", matchIfMissing = true)
public class PipiTracerAutoConfiguration {
