package com.pet.pipi.framework.ratelimiter.config;

import com.pet.pipi.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.pet.pipi.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.pet.pipi.framework.ratelimiter.core.keyresolver.impl.*;
import com.pet.pipi.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class PipiRateLimiterConfiguration {
