package com.pet.pipi.module.member.controller.admin.config;

import com.pet.pipi.framework.common.pojo.CommonResult;
import com.pet.pipi.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.pet.pipi.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.pet.pipi.module.member.convert.config.MemberConfigConvert;
import com.pet.pipi.module.member.dal.dataobject.config.MemberConfigDO;
import com.pet.pipi.module.member.service.config.MemberConfigService;
