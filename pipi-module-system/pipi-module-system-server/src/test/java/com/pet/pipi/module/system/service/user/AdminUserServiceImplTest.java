package com.pet.pipi.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.pet.pipi.framework.common.enums.CommonStatusEnum;
import com.pet.pipi.framework.common.exception.ServiceException;
import com.pet.pipi.framework.common.pojo.CommonResult;
import com.pet.pipi.framework.common.pojo.PageResult;
import com.pet.pipi.framework.common.util.collection.ArrayUtils;
import com.pet.pipi.framework.common.util.collection.CollectionUtils;
import com.pet.pipi.framework.test.core.ut.BaseDbUnitTest;
import com.pet.pipi.module.infra.api.config.ConfigApi;
import com.pet.pipi.module.infra.api.file.FileApi;
import com.pet.pipi.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.pet.pipi.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.pet.pipi.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.pet.pipi.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.pet.pipi.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.pet.pipi.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.pet.pipi.module.system.dal.dataobject.dept.DeptDO;
import com.pet.pipi.module.system.dal.dataobject.dept.PostDO;
import com.pet.pipi.module.system.dal.dataobject.dept.UserPostDO;
import com.pet.pipi.module.system.dal.dataobject.tenant.TenantDO;
import com.pet.pipi.module.system.dal.dataobject.user.AdminUserDO;
import com.pet.pipi.module.system.dal.mysql.dept.UserPostMapper;
import com.pet.pipi.module.system.dal.mysql.user.AdminUserMapper;
import com.pet.pipi.module.system.enums.common.SexEnum;
import com.pet.pipi.module.system.service.dept.DeptService;
import com.pet.pipi.module.system.service.dept.PostService;
import com.pet.pipi.module.system.service.oauth2.OAuth2TokenService;
import com.pet.pipi.module.system.service.permission.PermissionService;
import com.pet.pipi.module.system.service.tenant.TenantService;
...
import static com.pet.pipi.framework.common.util.collection.SetUtils.asSet;
import static com.pet.pipi.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.pet.pipi.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.pet.pipi.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.pet.pipi.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.pet.pipi.framework.test.core.util.AssertUtils.assertServiceException;
import static com.pet.pipi.framework.test.core.util.RandomUtils.*;
import static com.pet.pipi.module.system.enums.ErrorCodeConstants.*;
import static com.pet.pipi.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("pipiyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("pipiyuanma");
        ...
        assertEquals("pipiyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("pipiyuanma"))).thenReturn("java");
