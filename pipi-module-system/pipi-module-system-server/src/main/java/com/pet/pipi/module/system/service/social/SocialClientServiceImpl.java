package com.pet.pipi.module.system.service.social;
...
import com.pet.pipi.framework.common.util.cache.CacheUtils;
import com.pet.pipi.framework.common.util.http.HttpUtils;
import com.pet.pipi.framework.common.util.object.BeanUtils;
import com.pet.pipi.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.pet.pipi.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.pet.pipi.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.pet.pipi.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.pet.pipi.module.system.dal.dataobject.social.SocialClientDO;
import com.pet.pipi.module.system.dal.mysql.social.SocialClientMapper;
import com.pet.pipi.module.system.dal.redis.RedisKeyConstants;
import com.pet.pipi.module.system.enums.social.SocialTypeEnum;
import com.pet.pipi.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.pet.pipi.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.pet.pipi.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${pipi.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${pipi.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/pipi-cloud/pulls/230
