...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.pet.pipicloud";
    private static final String ARTIFACT_ID = "pipi";
    private static final String PACKAGE_NAME = "com.pet.pipi";
    private static final String TITLE = "PiPi宠物店管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.pet.pipicloud";
        String artifactIdNew = "pipi";
        String packageNameNew = "com.pet.pipi";
        String titleNew = "PiPi宠物店管理系统";
        String projectBaseDirNew = "D:\\dev\\java\\cloud-pipi" + "-new"; // 一键改名后，“新”项目所在的目录
