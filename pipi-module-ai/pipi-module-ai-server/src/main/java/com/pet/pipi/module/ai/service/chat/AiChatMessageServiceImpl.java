package com.pet.pipi.module.ai.service.chat;
...
import com.pet.pipi.framework.common.util.object.BeanUtils;
import com.pet.pipi.framework.tenant.core.util.TenantUtils;
import com.pet.pipi.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.pet.pipi.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.pet.pipi.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.pet.pipi.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.pet.pipi.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.pet.pipi.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.pet.pipi.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.pet.pipi.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.pet.pipi.module.ai.dal.dataobject.model.AiModelDO;
import com.pet.pipi.module.ai.dal.dataobject.model.AiToolDO;
import com.pet.pipi.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.pet.pipi.module.ai.enums.ErrorCodeConstants;
import com.pet.pipi.module.ai.enums.model.AiPlatformEnum;
import com.pet.pipi.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.pet.pipi.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.pet.pipi.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.pet.pipi.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.pet.pipi.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.pet.pipi.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.pet.pipi.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.pet.pipi.module.ai.service.model.AiChatRoleService;
import com.pet.pipi.module.ai.service.model.AiModelService;
import com.pet.pipi.module.ai.service.model.AiToolService;
import com.pet.pipi.module.ai.util.AiUtils;
import com.pet.pipi.module.ai.util.FileTypeUtils;
...
import static com.pet.pipi.framework.common.pojo.CommonResult.error;
import static com.pet.pipi.framework.common.pojo.CommonResult.success;
import static com.pet.pipi.framework.common.util.collection.CollectionUtils.convertList;
import static com.pet.pipi.framework.common.util.collection.CollectionUtils.convertSet;
import static com.pet.pipi.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.pet.pipi.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 pipi.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 pipi.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
