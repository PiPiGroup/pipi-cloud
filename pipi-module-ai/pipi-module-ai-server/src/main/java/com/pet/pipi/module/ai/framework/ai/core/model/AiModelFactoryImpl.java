package com.pet.pipi.module.ai.framework.ai.core.model;
...
import com.pet.pipi.framework.common.util.spring.SpringUtils;
import com.pet.pipi.module.ai.enums.model.AiPlatformEnum;
import com.pet.pipi.module.ai.framework.ai.config.AiAutoConfiguration;
import com.pet.pipi.module.ai.framework.ai.config.PipiAiProperties;
...
import com.pet.pipi.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.pet.pipi.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            PipiAiProperties.Midjourney properties = SpringUtil.getBean(PipiAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(PipiAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        PipiAiProperties.DouBao properties = new PipiAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(PipiAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        PipiAiProperties.HunYuan properties = new PipiAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(PipiAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        PipiAiProperties.SiliconFlow properties = new PipiAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(PipiAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        PipiAiProperties.XingHuo properties = new PipiAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(PipiAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        PipiAiProperties.BaiChuan properties = new PipiAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(PipiAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        PipiAiProperties.Gemini properties = SpringUtil.getBean(PipiAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        PipiAiProperties.Grok properties = new PipiAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
