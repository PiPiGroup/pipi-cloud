package com.pet.pipi.module.mp.service.account;
...
import com.pet.pipi.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.pet.pipi.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.pet.pipi.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.pet.pipi.module.mp.convert.account.MpAccountConvert;
import com.pet.pipi.module.mp.dal.dataobject.account.MpAccountDO;
import com.pet.pipi.module.mp.dal.mysql.account.MpAccountMapper;
import com.pet.pipi.module.mp.enums.ErrorCodeConstants;
import com.pet.pipi.module.mp.framework.mp.core.MpServiceFactory;
...
import static com.pet.pipi.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 pipi-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
