package com.pet.pipi.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.core.util.StrUtil;
import com.pet.pipi.framework.common.pojo.PageResult;
import com.pet.pipi.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.pet.pipi.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.pet.pipi.module.mp.convert.message.MpMessageConvert;
import com.pet.pipi.module.mp.dal.dataobject.account.MpAccountDO;
import com.pet.pipi.module.mp.dal.dataobject.message.MpMessageDO;
import com.pet.pipi.module.mp.dal.dataobject.user.MpUserDO;
import com.pet.pipi.module.mp.dal.mysql.message.MpMessageMapper;
import com.pet.pipi.module.mp.enums.message.MpMessageSendFromEnum;
import com.pet.pipi.module.mp.framework.mp.core.MpServiceFactory;
import com.pet.pipi.module.mp.framework.mp.core.util.MpUtils;
import com.pet.pipi.module.mp.service.account.MpAccountService;
import com.pet.pipi.module.mp.service.material.MpMaterialService;
import com.pet.pipi.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.pet.pipi.module.mp.service.user.MpUserService;
...
import static com.pet.pipi.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
