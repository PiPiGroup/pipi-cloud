package com.pet.pipi.module.infra.controller.admin.codegen;
...
import com.pet.pipi.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.pet.pipi.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.pet.pipi.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.pet.pipi.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.pet.pipi.module.infra.convert.codegen.CodegenConvert;
...
import com.pet.pipi.module.infra.service.codegen.CodegenService;
...
import static com.pet.pipi.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.pet.pipi.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "pipi"),
