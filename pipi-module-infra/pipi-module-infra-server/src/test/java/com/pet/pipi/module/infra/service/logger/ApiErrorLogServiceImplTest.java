package com.pet.pipi.module.infra.service.logger;
...
import com.pet.pipi.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.pet.pipi.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.pet.pipi.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.pet.pipi.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.pet.pipi.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.pet.pipi.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("pipi-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("pipi-test");
