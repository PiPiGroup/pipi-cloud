...
import com.pet.pipi.framework.mybatis.core.util.MyBatisUtils;
...
import com.pet.pipi.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import com.pet.pipi.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import com.pet.pipi.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import com.pet.pipi.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import com.pet.pipi.module.trade.convert.brokerage.BrokerageRecordConvert;
import com.pet.pipi.module.trade.dal.dataobject.brokerage.BrokerageRecordDO;
import com.pet.pipi.module.trade.dal.dataobject.brokerage.BrokerageUserDO;
import com.pet.pipi.module.trade.dal.dataobject.config.TradeConfigDO;
import com.pet.pipi.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
import com.pet.pipi.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import com.pet.pipi.module.trade.enums.brokerage.BrokerageRecordStatusEnum;
import com.pet.pipi.module.trade.service.brokerage.bo.BrokerageAddReqBO;
import com.pet.pipi.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static com.pet.pipi.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.pet.pipi.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.pet.pipi.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.pet.pipi.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
