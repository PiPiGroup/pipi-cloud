...
import com.pet.pipi.framework.common.util.string.StrUtils;
import com.pet.pipi.framework.dict.core.DictFrameworkUtils;
import com.pet.pipi.framework.ip.core.utils.AreaUtils;
import com.pet.pipi.module.member.api.address.dto.MemberAddressRespDTO;
import com.pet.pipi.module.member.api.user.dto.MemberUserRespDTO;
import com.pet.pipi.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.pet.pipi.module.pay.enums.DictTypeConstants;
import com.pet.pipi.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.pet.pipi.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.pet.pipi.module.product.api.sku.dto.ProductSkuRespDTO;
import com.pet.pipi.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.pet.pipi.module.product.api.spu.dto.ProductSpuRespDTO;
import com.pet.pipi.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.pet.pipi.module.trade.api.order.dto.TradeOrderRespDTO;
import com.pet.pipi.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.pet.pipi.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.pet.pipi.module.trade.controller.admin.order.vo.*;
import com.pet.pipi.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.pet.pipi.module.trade.controller.app.order.vo.*;
import com.pet.pipi.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.pet.pipi.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.pet.pipi.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.pet.pipi.module.trade.framework.order.config.TradeOrderProperties;
import com.pet.pipi.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.pet.pipi.framework.common.util.collection.CollectionUtils.convertMap;
import static com.pet.pipi.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static com.pet.pipi.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/pipicode/pipi-mall-uniapp/issues/ICY7SJ
