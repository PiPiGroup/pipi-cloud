package com.pet.pipi.module.promotion.controller.admin.kefu.vo.message;
...
public class KeFuMessageRespVO {
    ...
    @Schema(description = "发送人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://pipi.com/images/avatar.jpg")
