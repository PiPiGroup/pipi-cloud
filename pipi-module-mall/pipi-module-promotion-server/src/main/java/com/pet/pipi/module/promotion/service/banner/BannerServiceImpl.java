package com.pet.pipi.module.promotion.service.banner;

import com.pet.pipi.framework.common.pojo.PageResult;
import com.pet.pipi.module.promotion.controller.admin.banner.vo.BannerCreateReqVO;
import com.pet.pipi.module.promotion.controller.admin.banner.vo.BannerPageReqVO;
import com.pet.pipi.module.promotion.controller.admin.banner.vo.BannerUpdateReqVO;
import com.pet.pipi.module.promotion.convert.banner.BannerConvert;
import com.pet.pipi.module.promotion.dal.dataobject.banner.BannerDO;
import com.pet.pipi.module.promotion.dal.mysql.banner.BannerMapper;
...
import static com.pet.pipi.module.promotion.enums.ErrorCodeConstants.BANNER_NOT_EXISTS;
