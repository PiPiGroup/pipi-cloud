package com.pet.pipi.module.iot.gateway.config;

import com.pet.pipi.module.iot.core.messagebus.core.IotMessageBus;
import com.pet.pipi.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import com.pet.pipi.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import com.pet.pipi.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import com.pet.pipi.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import com.pet.pipi.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import com.pet.pipi.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import com.pet.pipi.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import com.pet.pipi.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import com.pet.pipi.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import com.pet.pipi.module.iot.gateway.protocol.mqttws.IotMqttWsDownstreamSubscriber;
import com.pet.pipi.module.iot.gateway.protocol.mqttws.IotMqttWsUpstreamProtocol;
import com.pet.pipi.module.iot.gateway.protocol.mqttws.manager.IotMqttWsConnectionManager;
import com.pet.pipi.module.iot.gateway.protocol.mqttws.router.IotMqttWsDownstreamHandler;
import com.pet.pipi.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import com.pet.pipi.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import com.pet.pipi.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import com.pet.pipi.module.iot.gateway.service.device.IotDeviceService;
import com.pet.pipi.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "pipi.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "pipi.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "pipi.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "pipi.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "pipi.iot.gateway.protocol.mqtt-ws", name = "enabled", havingValue = "true")
    @Slf4j
