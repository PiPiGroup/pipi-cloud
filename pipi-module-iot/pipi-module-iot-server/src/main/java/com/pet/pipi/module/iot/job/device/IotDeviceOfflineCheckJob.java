package com.pet.pipi.module.iot.job.device;

import cn.hutool.core.collection.CollUtil;
import com.pet.pipi.framework.common.util.json.JsonUtils;
import com.pet.pipi.framework.tenant.core.job.TenantJob;
...
import com.pet.pipi.module.iot.framework.iot.config.PipiIotProperties;
...
public class IotDeviceOfflineCheckJob {
    ...
    @Resource
    private PipiIotProperties iotProperties;
