package com.pet.pipi.module.iot.api.device;

import com.pet.pipi.framework.common.enums.RpcConstants;
...
import com.pet.pipi.module.iot.core.biz.dto.IotDeviceGetReqDTO;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 pipi-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
