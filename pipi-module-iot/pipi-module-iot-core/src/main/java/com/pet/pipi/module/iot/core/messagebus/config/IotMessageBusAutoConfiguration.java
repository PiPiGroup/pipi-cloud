package com.pet.pipi.module.iot.core.messagebus.config;

import com.pet.pipi.framework.mq.redis.core.RedisMQTemplate;
import com.pet.pipi.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.pet.pipi.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.pet.pipi.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.pet.pipi.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.pet.pipi.module.iot.core.messagebus.core.IotMessageBus;
import com.pet.pipi.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.pet.pipi.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.pet.pipi.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "pipi.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "pipi.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 PipiRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.pet.pipi.framework.mq.redis.config.PipiRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "pipi.iot.message-bus", name = "type", havingValue = "redis")
