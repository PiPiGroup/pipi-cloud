package com.pet.pipi.module.pay.service.refund;

import cn.hutool.extra.spring.SpringUtil;
import com.pet.pipi.framework.common.pojo.PageResult;
import com.pet.pipi.framework.test.core.ut.BaseDbAndRedisUnitTest;
import com.pet.pipi.module.pay.api.refund.dto.PayRefundCreateReqDTO;
import com.pet.pipi.module.pay.controller.admin.refund.vo.PayRefundExportReqVO;
import com.pet.pipi.module.pay.controller.admin.refund.vo.PayRefundPageReqVO;
import com.pet.pipi.module.pay.dal.dataobject.app.PayAppDO;
import com.pet.pipi.module.pay.dal.dataobject.channel.PayChannelDO;
import com.pet.pipi.module.pay.dal.dataobject.order.PayOrderDO;
import com.pet.pipi.module.pay.dal.dataobject.refund.PayRefundDO;
import com.pet.pipi.module.pay.dal.mysql.refund.PayRefundMapper;
import com.pet.pipi.module.pay.dal.redis.no.PayNoRedisDAO;
import com.pet.pipi.module.pay.enums.PayChannelEnum;
import com.pet.pipi.module.pay.enums.notify.PayNotifyTypeEnum;
...
import com.pet.pipi.module.pay.framework.pay.config.PayProperties;
import com.pet.pipi.module.pay.framework.pay.core.client.PayClient;
import com.pet.pipi.module.pay.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import com.pet.pipi.module.pay.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import com.pet.pipi.module.pay.service.app.PayAppService;
import com.pet.pipi.module.pay.service.channel.PayChannelService;
import com.pet.pipi.module.pay.service.notify.PayNotifyService;
import com.pet.pipi.module.pay.service.order.PayOrderService;
...
import static com.pet.pipi.framework.test.core.util.RandomUtils.randomPojo;
import static com.pet.pipi.framework.test.core.util.RandomUtils.randomString;
import static com.pet.pipi.module.pay.enums.ErrorCodeConstants.*;
