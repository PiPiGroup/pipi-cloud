package com.pet.pipi.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.pet.pipi.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
