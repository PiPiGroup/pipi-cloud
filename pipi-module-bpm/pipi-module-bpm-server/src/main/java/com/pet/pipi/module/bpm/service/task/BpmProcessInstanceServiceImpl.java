package com.pet.pipi.module.bpm.service.task;
...
import com.pet.pipi.framework.common.util.collection.CollectionUtils;
import com.pet.pipi.framework.common.util.date.DateUtils;
import com.pet.pipi.framework.common.util.json.JsonUtils;
import com.pet.pipi.framework.common.util.object.ObjectUtils;
import com.pet.pipi.framework.common.util.object.PageUtils;
import com.pet.pipi.framework.datapermission.core.annotation.DataPermission;
import com.pet.pipi.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.pet.pipi.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.pet.pipi.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.pet.pipi.module.bpm.controller.admin.task.vo.instance.*;
import com.pet.pipi.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.pet.pipi.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.pet.pipi.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.pet.pipi.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.pet.pipi.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.pet.pipi.module.bpm.enums.ErrorCodeConstants;
import com.pet.pipi.module.bpm.enums.definition.BpmModelTypeEnum;
import com.pet.pipi.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.pet.pipi.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.pet.pipi.module.bpm.enums.task.BpmReasonEnum;
import com.pet.pipi.module.bpm.enums.task.BpmTaskStatusEnum;
import com.pet.pipi.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.pet.pipi.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.pet.pipi.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.pet.pipi.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.pet.pipi.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.pet.pipi.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.pet.pipi.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.pet.pipi.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.pet.pipi.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.pet.pipi.module.bpm.service.definition.BpmProcessDefinitionService;
import com.pet.pipi.module.bpm.service.message.BpmMessageService;
import com.pet.pipi.module.system.api.dept.DeptApi;
import com.pet.pipi.module.system.api.dept.dto.DeptRespDTO;
import com.pet.pipi.module.system.api.user.AdminUserApi;
import com.pet.pipi.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.pet.pipi.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.pet.pipi.module.bpm.enums.ErrorCodeConstants.*;
import static com.pet.pipi.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.pet.pipi.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/pipi-cloud/issues/ID1UYA
